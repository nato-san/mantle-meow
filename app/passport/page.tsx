    ...
    <AppShell>
      ...
      <section className="grid gap-4 lg:grid-cols-[0.82fr_1.18fr]">
        <div className="neon-panel rounded-lg p-4">
          ...
          <section className="mt-4 rounded-lg border border-coral/35 bg-coral/10 p-4">
                ...
                {completedTasks.map((task) => {
                  ...
                  return (
                    <article key={task.id} className="rounded-lg border border-mint/25 bg-mint/10 p-4">
                      ...
                      <p className="mt-3 inline-flex rounded-md border border-mint/35 bg-ink/70 px-2 py-1 text-xs font-black text-mint">
                        +{task.xp} Bonus XP
                      </p>
                    </article>
                  );
